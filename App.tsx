    ...
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <header className="bg-white/90 backdrop-blur-md border-b border-black/5 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 cursor-pointer shrink-0" onClick={() => { setView('diagnosis'); handleReset(); }}>
            <div className="w-8 h-8 bg-black rounded-lg flex items-center justify-center text-white font-bold text-base">D</div>
            <span className="font-bold text-lg sm:text-xl tracking-tight text-black">DermaAI</span>
          </div>
          ...
          <nav className="flex items-center gap-2 sm:gap-6">
            ...
            <div className="flex bg-gray-100 p-1 rounded-full text-xs">
                <button 
                  ...
                  className={`px-3 sm:px-4 py-1.5 rounded-full font-bold transition-all ${view === 'diagnosis' ? 'bg-white text-black shadow-sm' : 'text-gray-500 hover:text-black'}`}
                >
                  Diagnosis
                </button>
                <button 
                  onClick={() => setView('glowup')} 
                  className={`px-3 sm:px-4 py-1.5 rounded-full font-bold transition-all ${view === 'glowup' ? 'bg-white text-black shadow-sm' : 'text-gray-500 hover:text-black'}`}
                >
                  Daily Tips
                </button>
            </div>
      ...
      <main className="w-full overflow-x-hidden">
        {error && (
          <div className="max-w-7xl mx-auto mt-4 sm:mt-6 px-3 sm:px-4">
          ...
          <Routes>
            <Route path="/" element={
              <div className="animate-fade-in">
                {/* HERO SECTION */}
                <section className="relative pt-8 pb-14 sm:pt-12 sm:pb-20 lg:pt-24 lg:pb-32 overflow-hidden">
                    <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
                        {/* Left Content */}
                        <div className="max-w-2xl relative z-10 text-left">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100 text-black text-[11px] sm:text-xs font-bold uppercase tracking-wider mb-4 sm:mb-6 border border-gray-200">
                                <span className="w-2 h-2 rounded-full bg-black"></span>
                                AI-Powered Dermatology & Trichology
                            </div>
                            <h1 className="text-3xl xs:text-4xl sm:text-5xl lg:text-7xl font-bold text-black leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6 tracking-tight">
                                Your Personal <br className="hidden xs:inline"/>
                        ...
                        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <button 
                              ...
                              className="bg-white p-5 sm:p-6 rounded-2xl border border-gray-200 hover:border-black hover:shadow-lg active:scale-[0.98] transition-all text-left flex flex-col group min-h-[120px]"
                            >
                               ...
                               <h3 className="font-bold text-black text-lg sm:text-xl mb-1 sm:mb-2">Skin Analysis</h3>
                               <p className="text-xs sm:text-sm text-gray-500">Clinical grade skin mapping</p>
                            </button>

                            {/* Card 2: Hair & Scalp Analysis */}
                            <button 
                              onClick={() => navigate('/scan/hair')}
                              className="bg-white p-5 sm:p-6 rounded-2xl border border-gray-200 hover:border-black hover:shadow-lg active:scale-[0.98] transition-all text-left flex flex-col group relative min-h-[120px]"
                            >
                               <div className="absolute top-4 right-4 bg-blue-100 text-blue-800 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
                                  Early Beta 🧪
                               </div>
                               <div className="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center text-black mb-4 group-hover:bg-black group-hover:text-white transition-colors">
                                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                               </div>
                               <h3 className="font-bold text-black text-lg sm:text-xl mb-1 sm:mb-2">Hair & Scalp Analysis</h3>
                               <p className="text-xs sm:text-sm text-gray-500">Deep-dive follicle & texture scan</p>
                            </button>
                        </div>
                    </div>
                </section>
                ...
                {/* FEATURES SECTION */}
                <section id="how-it-works" className="py-14 sm:py-20 lg:py-24 bg-white border-t border-gray-100">
                   <div className="container mx-auto px-4">
                      <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
                         <h2 className="text-2xl sm:text-3xl font-bold text-black mb-3 sm:mb-4">Precision Analysis</h2>
                         <p className="text-sm sm:text-lg text-gray-500">Our multi-model AI scans distinct dimensions of skin and hair health to provide a holistic diagnosis.</p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
                         {[
                            ...
                            { title: "Hair Texture", desc: "Analyzes curl pattern and strand health.", icon: (
                             ...
                             <div key={idx} className="bg-white p-5 sm:p-8 rounded-2xl border border-gray-200 hover:border-black hover:shadow-lg transition-all group">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-50 rounded-xl flex items-center justify-center text-black mb-4 sm:mb-6 group-hover:bg-black group-hover:text-white transition-colors">
                                   <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                      {feature.icon}
                                   </svg>
                                </div>
                                <h3 className="font-bold text-black text-lg sm:text-xl mb-2 sm:mb-3">{feature.title}</h3>
                ...
                <footer className="bg-black text-white py-12 sm:py-16 border-t border-gray-800">
                    <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 text-center md:text-left">
                        {/* Column 1: Brand */}
                        <div className="flex flex-col items-center md:items-start">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <span className="font-bold text-xl sm:text-2xl text-white">DermaAI</span>
                            </div>
                        ...
                        <div className="flex flex-col gap-2.5">
                           <h4 className="text-white font-bold text-sm sm:text-base mb-1">Legal & Privacy</h4>
                           <a href="#" className="text-xs sm:text-sm hover:text-gray-300 transition-colors">Privacy Policy</a>
                           <a href="#" className="text-xs sm:text-sm hover:text-gray-300 transition-colors">Terms of Service</a>
                           <a href="#" className="text-xs sm:text-sm hover:text-gray-300 transition-colors">Medical Disclaimer</a>
                        </div>
                        
                        {/* Column 3: Disclaimer */}
                        <div>
                           <h4 className="text-white font-bold text-sm sm:text-base mb-1">Important Medical Disclaimer</h4>
            ...
            <Route path="/scan/skin" element={
              <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
                ...
                {step === AppStep.ANALYZING && (
                  <div className="flex flex-col items-center justify-center py-20 sm:py-32 animate-fade-in text-center px-4">
                    <div className="relative">
                      <div className="w-20 h-20 sm:w-24 sm:h-24 border-4 border-gray-200 rounded-full"></div>
                      <div className="absolute top-0 left-0 w-20 h-20 sm:w-24 sm:h-24 border-4 border-black rounded-full border-t-transparent animate-spin"></div>
                      <div className="absolute inset-0 flex items-center justify-center text-black font-bold text-lg sm:text-xl">AI</div>
                    </div>
                    <h2 className="mt-6 sm:mt-8 text-2xl sm:text-3xl font-bold text-black">Analyzing Your Skin Profile</h2>
                    <p className="mt-2 text-gray-500 text-sm sm:text-lg">Cross-referencing 3 angles with dermatological data...</p>
                  </div>
                )}
              ...
              <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
                ...
                {step === AppStep.ANALYZING && (
                  <div className="flex flex-col items-center justify-center py-20 sm:py-32 animate-fade-in text-center px-4">
                    ...
                    <h2 className="mt-6 sm:mt-8 text-2xl sm:text-3xl font-bold text-black">Analyzing Your Hair Profile</h2>
                    <p className="mt-2 text-gray-500 text-sm sm:text-lg">Cross-referencing 4 angles with trichological data...</p>
                  </div>
                )}
